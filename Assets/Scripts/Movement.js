...
/**
 * Inherited from MonoBehavior. Called every frame.
 ...
 * Sets rotationX and rotationY based on the "Transform" values in the Inspector.
 *
 * @method Start
 */
function Start()
...
/**
 * Returns whether the mouse has moved since the last frame.
 *
 * @method MouseMoved
 * @return {boolean} true if the mouse has changed position since the last frame, otherwise false
 */
function MouseMoved()
{
